...
export class SelectCategoryExpense extends React.Component {
  render() {
    return (
      <Input type="select" defaultValue="" onChange={this.props.change} name="selectCategory" className="icons selectCategory">
...
export class SelectCategoryIncome extends React.Component {
  render() {
    return (
      <Input type="select" defaultValue="" onChange={this.props.change} name="selectCategory" className="icons selectCategory">
        <option value="" disabled>Wybierz Kategorię</option>
